...
global.pollen_config_pfx = [
...

    {
        ...
        emitterList : [
            ...
            {
                type: "type_example_min",
                relative: true, //<---NOTE: This must be before .SetNumber or changes won't be reflected properly
                number: 100,
                width: 64,
                height: 64,
            ...
            // { //<---Example of how to define a type inside an emitter struct (uncomment and save to see how it works)
            //     type: {
            //         type: "type_in_emitter",
            //         // tag: "type_in_emitter", //<---Can also use 'tag' instead to prevent confusion from nesting 'type' property inside of another 'type' property
            //         shape: pt_shape_line,
