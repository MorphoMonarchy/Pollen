...
Import data from a GML 'JSON' array (see info about setting up 'JSON' in [Config PFX](<Config PFX.md/>))
...
Copy data from a GML 'JSON' type struct into a Pollen.Type instance (see info about setting up 'JSON' in [Config PFX](<Config PFX.md/>))
