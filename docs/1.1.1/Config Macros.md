...
The following macros can be found in the `__scr_pollen_config_macros` script.  
...
Whether Pollen should automatically import global.pollen_config_pfx after initialization. If false, you must manually import effects using [`Pollen.ImportPfx()`](https://morphomonarchy.github.io/Pollen/#/1.1.1/Import%20Particles?id=importpfxdata-%e2%86%92-undefined).
